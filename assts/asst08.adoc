...
"first-fit" strategy and analyze its performance. 

For this assignment, you should submit both 

* your code, and
* a written report, *due in class, November 17th*
...
* The amount of underutilised memory as a percentage. This is the percent of memory that is held in buffers but not being used.
